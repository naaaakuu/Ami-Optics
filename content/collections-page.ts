...
export const frameFamilies: FrameFamily[] = [
  ...
  },
  {
    ...
    description:
      "Acetate brings warmth and personality that metal can't — rich colours, patterns and confident shapes. A great choice when your spectacles should say something about you.",
  ...
  },
  {
    ...
    description:
      "No rims, almost no weight — just your lenses, held by fine temples and a bridge. Rimless frames disappear on the face, letting your features (not your eyewear) lead.",
  ...
  },
  {
    ...
    description:
      "A frame along the top for definition, open below for lightness. Half-rims strike a professional balance — structured enough for the office, light enough for all day.",
  ...
  },
  {
    ...
    note: "One frame, two looks — indoors and sun.",
    description:
...
export const lensTechnologies: LensTech[] = [
  {
    ...
    line: "Calmer eyes after long screen hours.",
    href: "/#lens-blue-cut",
  },
  {
    name: "Progressive Lenses",
    line: "One pair, every distance.",
    href: "/#lens-progressive",
  },
  {
    name: "Photochromic Lenses",
    line: "Clear indoors, shaded outdoors.",
    href: "/#lens-photochromic",
  },
  {
    name: "High-Index Thin Lenses",
    line: "Strong prescription, slim lens.",
    href: "/#lens-high-index",
  },
  {
    name: "Anti-Glare Lenses",
    line: "See clearly, be seen clearly.",
    href: "/#lens-anti-glare",
  },
  {
    name: "Polarised Lenses",
    line: "Cut the glare, keep the view.",
    href: "/#lens-polarised",
  },
];
...
export const specialtyRanges: SpecialtyRange[] = [
  ...
  },
  {
    ...
    description:
      "UV protection that looks as good as it works — everyday fashion pairs, kids' sunglasses and specialty options, curated alongside our prescription eyewear.",
    image: {
