...
export const heritageStory: string[] = [
  "Our story did not begin with a shop. It began in Mumbai's wholesale spectacle market, where Vinodchandra Vora sourced frames and supplied opticians across the region — until the trade closed, but the family's bond with optics never did.",
...
export const homeStoryChapters: { year: string; title: string; body: string }[] = [
  ...
  },
  {
    ...
    body: "A move to the crossroads at Jivdani Chowk, where four roads meet. One shop quietly became three — earned through honest advice, never shortcuts.",
  },
  {
    year: "Today",
...
export const heritageMilestones: HeritageMilestone[] = [
  ...
  },
  {
    ...
    description:
      "Trust compounded. One shop quietly grew into two, and then into three connected shops — earned through consistency, never shortcuts.",
  },
  {
    year: "Then",
