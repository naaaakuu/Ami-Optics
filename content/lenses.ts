...
export const lenses: Lens[] = [
  ...
  },
  {
    ...
    description:
      "Reading, screen and distance vision flow together in a single lens with no visible lines and no second pair to swap to.",
  ...
  },
  {
    ...
    description:
      "Thinner, lighter lenses for higher prescriptions. The same clarity and comfort, just without the thickness.",
